...
namespace MadLibs
{
    public static class Definitions
    {
        public static string instructions = "You are essentially filling in the blanks to finish a story, but you won't see the story until the end. \n " +
            "You will be prompted to come up with different word types such as noun, verb, adverb, etc. The more clever and unique, the better. Don't worry, if you missed your grade 5 grammar lesson, we've got you covered. We'll tell you exactly what word types mean what.\n The words you come up with will be inserted randomly into the story where there are blanks. Try to be as creative and silly as you can, using thoughtful, descriptive words for hilarious results. If you don't pick a word, we will insert our own and we make no promises it won't be super weird.";
